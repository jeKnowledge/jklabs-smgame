...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/dethos/jeknowledge/jklabs-smgame/stock_market_game/temp.db', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'abi4pdj1$uer&i!3dv3fpm1a%#68v-9_^7j-bcq*&p_g!%-g9$'
